...
- Свойства — единичные данные, описывающие объект.
- Состояние — совокупность всех свойств объекта.
- Исполнитель — объект, способный выполнять действия, которые могут менять его свойства, переводя объект из одного состояния в другое.
- Граф состояний — множество состояний, связанных между собой действиями, которые переводят объект из одного в другое состояние.
- Алгоритм — последовательность действий. В графе состояний это маршрут, по которому двигается исполнитель, решая поставленную задачу.
- Команда — понятный исполнителю сигнал к действию.
- Язык исполнителя — полный набор таких команд.
...
## Сигнал
Изменения в структуре, имеющее смысл, называется сигналом. Перепад напряжения, удар колокола, голос диктора, вспышка прожектора, чернильный след — все это может быть сигналом.
